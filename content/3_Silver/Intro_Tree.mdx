...
- A graph is a **tree** if it is connected and contains $N$ nodes and $N-1$ edges
- A graph is a **tree** if every pair of nodes has exactly one simple path between them
